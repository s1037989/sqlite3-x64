...
[**RELEASES**](https://github.com/boramalper/sqlite3-x64-binaries/releases)
...
2. Whenever changes are pushed to [the GitHub repository](https://github.com/boramalper/sqlite3-x64-binaries),
   [Travis CI](https://travis-ci.org/boramalper/sqlite3-x64-binaries):
   1. Compiles the binaries and zips them
   2. Creates a new [release](https://github.com/boramalper/sqlite3-x64-binaries/releases)
...
build log on [Travis CI](https://travis-ci.org/boramalper/sqlite3-x64-binaries)
